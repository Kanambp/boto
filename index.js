...
console.log(color('🐶 WA NUMBER: +254114148625 ','silver'))
console.log(color('  🦄Xeon Bot Inc. 2022🦄','mediumseagreen'))
    ...
    console.log(color('🐶', 'cyan'), color('https://wa.me//254114148625'))
    console.log(color('🐶', 'cyan'), color('KANAMBO THE PRODICAL BOT Is Online...', 'pink'))
